...
export default function SignupPage() {
  ...
  return (
    ...
    >
      ...
      <Card className="w-full max-w-md glass-professional border-white/20">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription className="text-foreground/70">
            Join thousands of beauty enthusiasts and start your AI-powered beauty journey
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="terms" className="text-sm text-foreground/70 cursor-pointer">
                I agree to the{" "}
                <Link href="/terms" className="text-pink-500 hover:text-pink-400 font-medium">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="text-pink-500 hover:text-pink-400 font-medium">
                  Privacy Policy
                </Link>
              </Label>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="glass-professional border-white/20 bg-transparent">
          ...
          <div className="text-center text-sm text-foreground/70">
            ...
            <Link href="/auth/login" className="text-pink-500 hover:text-pink-400 font-medium">
              Sign in
            </Link>
          </div>
        </CardContent>
