...
const models = [
	...
	},
	{
		...
		image: "/images/hero/makeup3.jpg",
		category: "Professional",
		description: "Perfect for work environment",
	},
	{
		id: 4,
					...
					<div className="space-y-6 text-center lg:text-left">
						...
						<div className="space-y-3">
							...
							<p className="text-lg lg:text-xl text-foreground/70 leading-relaxed max-w-xl mx-auto lg:mx-0">
								AI-Powered Makeup & Skin Analysis Tailored Just for You. Experience personalized beauty
								recommendations with cutting-edge technology.
							</p>
						</div>
										...
										<div className="relative group h-full">
											...
											<div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-500">
												<div className="absolute bottom-4 left-4 right-4 text-white">
													<div className="text-xs font-medium text-pink-300 mb-1">
														{model.category}
													</div>
